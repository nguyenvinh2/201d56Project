...
var factPool = ['I like to watch "Epic Sax Man" on repeat once a week', 'If I could be any fruit, I\'d be an apple. How about dem apples? ','My guilty pleasure is Ryan Gosling movies.','I am really from a small planet somewhere in the vincinity of betelgeuse','I write poetry about poetry.','I am the new Mayor of Quahog','I always have my towel.','I wear long sleeve shirts under short sleeve shirts under long sleeve shirts','Dont make me angry. You wouldn\'t like me when I\'m angry...','I always wonder, WHAT\'S IN THE BOX??!!','There\'s a passage I learned that seemed appropriate for the moment: Ezekiel 25:17.','I don\'t want to be a product of my environment. I want my environment to be a product of me','I want to make a movie about a theme park with dinosaurs.. Original, right?','I like to sing Phil Collin\'s "In the Air Tonight", and subsequently get punched in the face by Mike Tyson.','I bowel really well with a hook hand.','Code 201 Final Project? AALLLLLRIGHTY THEN!','I watch Tommy Boy just to hear Chris Farely say "holy schnikes".','I have a beautiful mind.... and I see people who aren\'t really there.','Me and my brother are Irish.. and vigilantes.','My perfect evening ends with a Dwayne Johnson singing ANY song.','I think that "The Prestige" and "The Illuionist are the same"','I wouldn\'t want anyone meddling in my personal life. That\'s why I cleverly have no personal life.','If greatness was measured in water, I\'d be the Pacific','You\'re not super bad unless you watch "Superbad".','If I had a million dollars, I probably wouldn\'t be in this game right now.','I am NUNYA of the House BUSINESS.','In HBO\'s "Game of Thrones: Who Will Take the Iron Throne?" question poll, why does Greyworm have 10% of the votes?','I wish I had a snickers.','I don\'t like turtles! :-p','On Thanksgiving Day, I watch the all Rocky movies... In reverse order.'];
...
function cardDeckInit(){
  ...
  allCards[0].facts = '#Dr. Van Code. I have furry companions that are AWE-SOME! One of them I bring to work regularly; The amazing Demi of the House Hamm!! First of her name.';
  allCards[1].facts = 'I am one of the coolest dogs with legs >= 3. Ask Sam!';
  allCards[2].facts = 'I created my own version of TRON and CLU. They are both annoying. I also have a dog named Charlie!';
  allCards[3].facts = 'I am John\'s roomie! Fun fact: I secretly rub my butt on John\'s pillow. You\'re welcome!';
  ...
  allCards[10].facts = 'I am an awesome Fellow of the House Code!';
  allCards[11].facts = 'I am a belieber!';
  allCards[12].facts = 'I am still working on a fact for myself. I\'ll let you know in Code 301.';
